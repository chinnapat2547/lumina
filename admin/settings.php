                    ...
                    <div id="tab-store" class="tab-content bg-surface-white dark:bg-surface-dark rounded-[2rem] shadow-card border border-pink-50 dark:border-gray-700 p-8 <?= $activeTab=='store'?'active':'' ?>">
                        ...
                        <form action="" method="POST" class="space-y-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div><label class="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-2">เบอร์โทรศัพท์ติดต่อ</label><input type="text" name="store_phone" value="081-234-5678" class="w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-gray-600 bg-gray-50 dark:bg-gray-800 dark:text-white focus:ring-2 focus:ring-primary/30 outline-none transition-all"></div>
                            </div>
                            ...
                            <div><label class="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-2">ที่อยู่ร้านค้า</label><textarea name="store_address" rows="3" class="w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-gray-600 bg-gray-50 dark:bg-gray-800 dark:text-white focus:ring-2 focus:ring-primary/30 outline-none transition-all resize-none">123 หมู่ 4 ถนนความสวย แขวงน่ารัก เขตสดใส กรุงเทพมหานคร 10110</textarea></div>
                        ...
                        <form action="" method="POST" class="space-y-8">
                            ...
                            <div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 bg-gray-50/50 dark:bg-gray-800/50 p-5 rounded-2xl border border-gray-100 dark:border-gray-700">
                                    <div><label class="block text-xs font-bold text-gray-500 dark:text-gray-400 mb-1">เลือกธนาคาร</label><select class="w-full px-4 py-2.5 rounded-xl border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-800 dark:text-white outline-none"><option value="kbank">กสิกรไทย</option><option value="scb">ไทยพาณิชย์</option></select></div>
                                    <div><label class="block text-xs font-bold text-gray-500 dark:text-gray-400 mb-1">เลขบัญชี</label><input type="text" value="123-4-56789-0" class="w-full px-4 py-2.5 rounded-xl border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-800 dark:text-white font-mono outline-none"></div>
                                </div>
                            </div>
